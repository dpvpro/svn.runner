...
class ListByPeriod(Resource):
    def get(self, from_date, till_date):
        ...
        query = conn.execute("select * from svn_action_log WHERE TimeStamp >= '{} 00:00' and TimeStamp <= '{} 23:59';".format(from_date, till_date))
        return {'Transaction for period ': query.cursor.fetchall()}
